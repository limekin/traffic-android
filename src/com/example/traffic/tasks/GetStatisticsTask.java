...
public class GetStatisticsTask extends AsyncTask<String, JSONObject, JSONObject> {
	
	private StatisticsFragment sourceActivity;
	
	public GetStatisticsTask(StatisticsFragment activity) {
	...
	protected void onPostExecute(JSONObject result) {
		sourceActivity.updateItems(result);
	}
	
	protected JSONObject getStatistics() throws IOException {
		String jsonResponse = "";
		JSONObject responseJson = new JSONObject();
		Log.i("HTTP", "Retrieving statistics details ...");
		
		try {
			
			// Initialize the client for sending the request.
			String url = AppConfig.API_BASE_URL + "/statistics";
			...
			Log.i("HTTP", "Status from /statistics [GET] : " + response.getStatusLine().toString());
			...
			Log.i("HTTP", "Reponse from /statistics [GET] : " + jsonResponse);
